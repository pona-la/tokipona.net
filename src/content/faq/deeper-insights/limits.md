...
But there are some aspects of Toki Pona which make it more challenging to use in
...
works well for small numbers, but becomes unwieldy as numbers approach several
hundred. Because it is unwieldly, Toki Pona naturally discourages using numbers.
Speakers often prefer descriptors like 'many' or 'few,' or 'old' or 'young,' or
they may round to the nearest 20 or 100 if describing quantities.
...
notation. Toki Pona speakers do not yet share a convention for verbalizing
...
numbers. Anecdotally, jan Mija is a Toki Pona speaker living in Canada who
...
it clearly, they need to take longer to explain. The discussion topics that
trigger this difficulty can depend more on the speaker and listener than the
language, and especially on their prior knowledge surrounding the topic.

For example, if the speaker or listener don't know much about electromagnetism,
discussing it might take far longer than it would in a different language,
because complex topics are built from the ground up. It might take several
...
on key context needed to disambiguate properly. This means that, even with
context provided, it is, more likely to be misunderstood in Toki Pona than other
languages.

For example, one speaker participating in a conversation may be using "waso" to
mean "airplane," but if the other speaker missed the context of travel, they
might assume that waso just refers to a bird. The best way to prevent this is by
double checking and asking clarifying questions. It's common to ask a clarifying
...
information, and find themselves confused or unable to follow the conversation
as a result. Thrust into the middle of a particularly complex conversation, it
may be difficult for the listener to even clearly identify the subject the
conversation.

For this reason, speakers may feel that Toki Pona is more difficult to skim
through or back-read.
